...
'<span class="token string">formatting</span>': group {
	...
	'<span class="token string">data type mapping</span>': [ <span class="token operator">data-types</span> ] group {
		...
		'<span class="token string">integer</span>': [ <span class="token operator">integer:</span> ] group {
			'<span class="token string">sql type</span>': text
			'<span class="token string">range</span>': [ <span class="token operator">[</span>, <span class="token operator">]</span> ] group {
				'<span class="token string">minimum</span>': integer
				'<span class="token string">maximum</span>': [ <span class="token operator">,</span> ] integer
			}
		}
		'<span class="token string">decimal</span>': [ <span class="token operator">decimal:</span> ] group {
			'<span class="token string">sql type</span>': text
			'<span class="token string">range</span>': [ <span class="token operator">[</span>, <span class="token operator">]</span> ] group {
				'<span class="token string">minimum</span>': integer
				'<span class="token string">maximum</span>': [ <span class="token operator">,</span> ] integer
		...
		'<span class="token string">date</span>': [ <span class="token operator">date:</span> ] group {
			'<span class="token string">sql type</span>': text
			'<span class="token string">range</span>': [ <span class="token operator">[</span>, <span class="token operator">]</span> ] group {
				'<span class="token string">minimum</span>': integer
				'<span class="token string">maximum</span>': [ <span class="token operator">,</span> ] integer
		...
		'<span class="token string">date-time</span>': [ <span class="token operator">date-time:</span> ] group {
			'<span class="token string">sql type</span>': text
			'<span class="token string">range</span>': [ <span class="token operator">[</span>, <span class="token operator">]</span> ] group {
				'<span class="token string">minimum</span>': integer
				'<span class="token string">maximum</span>': [ <span class="token operator">,</span> ] integer
				...
				'<span class="token string">representation</span>': stategroup (
					'<span class="token string">decimal</span>' {
						'<span class="token string">conversion</span>': stategroup (
							'<span class="token string">none</span>' { [ <span class="token operator">integer</span> ] }
							'<span class="token string">point translation</span>' { [ <span class="token operator">decimal</span> <span class="token operator">(</span>, <span class="token operator">)</span> ]
								'<span class="token string">precision</span>': integer
								'<span class="token string">scale</span>': [ <span class="token operator">,</span> ] integer
							}
						)
					}
