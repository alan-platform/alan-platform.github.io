...
'<span class="token string">tables</span>': [ <span class="token operator">schema</span> ] dictionary { @block indent
	'<span class="token string">primary key</span>': [ <span class="token operator"><--</span> ] group {
		...
		'<span class="token string">has key fields</span>': stategroup = match .'<span class="token string">key fields</span>' (
	...
	'<span class="token string">has fields</span>': stategroup = match .'<span class="token string">fields</span>' (
