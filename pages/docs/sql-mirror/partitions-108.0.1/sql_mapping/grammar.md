...
'<span class="token string">formatting</span>': group {
	...
	'<span class="token string">data type mapping</span>': [ <span class="token operator">data-types</span> ] group {
		...
		'<span class="token string">integer</span>': [ <span class="token operator">integer:</span> ] text
		'<span class="token string">decimal</span>': [ <span class="token operator">decimal:</span> ] text
