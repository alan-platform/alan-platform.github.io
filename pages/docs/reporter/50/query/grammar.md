...
'<span class="token string">query type</span>': stategroup (
	'<span class="token string">collection</span>' { [ <span class="token operator">collection:</span> ]
		...
		'<span class="token string">properties</span>': [ <span class="token operator">select</span> ] dictionary @order: .'<span class="token string">order</span>' {
		...
		'<span class="token string">has first</span>': stategroup = match .'<span class="token string">properties</span>' (
