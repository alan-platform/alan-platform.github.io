...
'<span class="token string">sibling reference definition</span>' {
	'<span class="token string">graph participation</span>': stategroup (
		...
		'<span class="token string">yes</span>' { [ <span class="token operator">in</span> <span class="token operator">(</span>, <span class="token operator">)</span> ] //TODO@GJK: drop these braces
			'<span class="token string">graph traversal</span>': component <a href="#grammar-rule--graph-traversal-definition">'graph traversal definition'</a>
		}
	)
}
