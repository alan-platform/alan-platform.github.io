...
'<span class="token string">ui text property</span>'
	...
	'<span class="token string">custom identifying properties?</span>' stategroup (
		'<span class="token string">no</span>'
		'<span class="token string">yes</span>' [ <span class="token operator">@custom-identifying-properties:</span> ]
			'<span class="token string">custom identifying properties</span>' [ <span class="token operator">(</span>, <span class="token operator">)</span> ] collection (
				'<span class="token string">property context</span>' component <a href="#grammar-rule--ui-node-path">'ui node path'</a>
