...
'path participation' group (
	'singular' component 'participation'
	'conditional' component 'participation'
)
```
...
```js
'unknown modifier' component 'modifier'
```
...
```js
'conditional descendant parameter path'
	'has steps' stategroup (
		'no'
		'yes'
			'state group' ['?'] reference
			'state' ['|'] reference
			'tail' component 'conditional descendant parameter path'
	)
```
...
'parametrized collection argument expression'
	'type' stategroup (
		...
		'parameter' ['map']
			...
			'collection' ['.'] reference
			'key property' ['[',']'] reference
			'filter' component 'conditional descendant parameter path'
...
'node step'
	'type' stategroup (
		...
		// 	'collection' ['.'] reference
		// 	'key path' ['[',']'] group (
		// 		'head' component 'conditional node path'
		// 		'text' reference
		// 	)
		'reference'
			'text' [ '>' ] reference
