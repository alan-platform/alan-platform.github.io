...
However, if an `@expected:` value can be determined, the GUI disables edit mode for the property.
For the user to modify the value, the user must manually enable edit mode.
