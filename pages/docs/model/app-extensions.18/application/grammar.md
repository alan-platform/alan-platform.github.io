...
```js
'multiplicity' group (
	'none'        component 'multiplicity type'
	'singular'    component 'multiplicity type'
	'plural'      component 'multiplicity type'
	'conditional' component 'multiplicity type'
)
```
