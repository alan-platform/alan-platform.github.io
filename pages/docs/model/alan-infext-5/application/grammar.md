						...
						'<span class="token string">type</span>': stategroup (
							...
							'<span class="token string">derived</span>' { [ <span class="token operator">=</span> ]
								'<span class="token string">value source</span>': stategroup (
									'<span class="token string">constructor</span>' { [ <span class="token operator">parameter</span> ] }
...
'Orders': collection ['ID'] {
    ...
    // a link to a 'Products' item from the catalog provider:
    'Product': text ~> ^ .'Products'[]
    'Product found': stategroup = node-switch >'Product' (
        | node  = 'Yes' ( 'Product' = $ )
        | none = 'No'
    ) (
...
'<span class="token string">derivation expression</span>' {
	'<span class="token string">type</span>': stategroup (
		...
		'<span class="token string">set switch</span>' { [ <span class="token operator">set-switch</span> ]
		...
		'<span class="token string">number switch</span>' { [ <span class="token operator">number-switch</span> ]
			'<span class="token string">left number path</span>': component <a href="#grammar-rule--singular-variablized-object-path">'singular variablized object path'</a>
			...
			'<span class="token string">cases</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] indent group { dynamic-order
				'<span class="token string">number</span>': @block group { [ <span class="token operator">|</span> <span class="token operator">number</span> ]
					'<span class="token string">variable assignment</span>': component <a href="#grammar-rule--optional-named-object-assignment">'optional named object assignment'</a>
					'<span class="token string">expression</span>': [ <span class="token operator">=></span> ] component <a href="#grammar-rule--derivation-expression">'derivation expression'</a>
				}
				'<span class="token string">none</span>': @block [ <span class="token operator">|</span> <span class="token operator">none</span>@pad2 <span class="token operator">=></span> ] component <a href="#grammar-rule--derivation-expression">'derivation expression'</a>
			}
		}
	)
}
...
'<span class="token string">user requirement</span>' {
	...
	'<span class="token string">operation</span>': stategroup (
		'<span class="token string">equality</span>' { [ <span class="token operator">is</span> ]
			'<span class="token string">other node path</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] component <a href="#grammar-rule--conditional-node-path">'conditional node path'</a>
		}
		'<span class="token string">existence</span>' { }
	)
