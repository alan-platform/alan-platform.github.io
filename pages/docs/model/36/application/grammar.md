...
// 	'tail' component 'singular descendant node path'
```
...
// 'Plural Node Expression Tail'//because we don't have lists/left recursion
// 	'path' component 'Plural Node Path'
// 	'has steps' stategroup (
// 		'no'
// 		'yes' [',']
// 			'tail' component 'Plural Node Expression Tail'
// 	)
// 'Plural Node Expression'
// 	'type' stategroup (
// 		'path'
// 			'path' component 'Plural Node Path'
// 		'union' ['(', ')']
// 			'expression' component 'Plural Node Expression Tail'
// 	)
```

### singular descendant node path
...
```js
'conditional descendant node path'
	'head' component 'singular descendant node path'
	'has steps' stategroup (
		'no'
		'yes'
			'state group' ['?'] reference
		...
		'containment' ['any']
			'context' stategroup (
				'user' ['user']
					...
					'matrix' ['.', '['] reference
					'key' ['$',']'] component 'conditional node path'
				...
				'definition' ['$']
					...
					'matrix' ['.', '['] reference
					'key' ['user',']'] component 'conditional descendant node path'
					'has filter' stategroup (
						'no'
						'yes' ['as' '$' 'where']
							'path' ['(', ')'] component 'user requirement'
