		...
		'<span class="token string">type</span>': stategroup (
			...
			'<span class="token string">node reference</span>' {
				'<span class="token string">type</span>': stategroup (
					...
					'<span class="token string">reference set containment</span>' {
						'<span class="token string">head</span>': component <a href="#grammar-rule--context-object-step">'context object step'</a>
						'<span class="token string">reference set path</span>': component <a href="#grammar-rule--plural-reference-set-path-tail">'plural reference set path tail'</a>
						'<span class="token string">node to find</span>': [ <span class="token operator">[</span>, <span class="token operator">]</span> ] component <a href="#grammar-rule--named-object-step">'named object step'</a>
					}
				)
			}
		)
...
'<span class="token string">object set path</span>' {
	'<span class="token string">head</span>': component <a href="#grammar-rule--context-object-step">'context object step'</a>
	'<span class="token string">set path</span>': component <a href="#grammar-rule--object-set-path-step">'object set path step'</a>
...
{: #grammar-rule--object-set-path-step }
<div class="language-js highlighter-rouge">
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">object set path step</span>' {
	'<span class="token string">path</span>': component <a href="#grammar-rule--object-path-tail">'object path tail'</a>
}
</pre>
</div>
...
{: #grammar-rule--plural-reference-set-path-tail }
<div class="language-js highlighter-rouge">
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">plural reference set path tail</span>' {
	'<span class="token string">reference set path</span>': component <a href="#grammar-rule--object-set-path-step">'object set path step'</a>
	'<span class="token string">has steps</span>': stategroup (
		'<span class="token string">no</span>' { }
		'<span class="token string">yes</span>' { [ <span class="token operator">*</span> ]
			'<span class="token string">tail</span>': component <a href="#grammar-rule--plural-reference-set-path-tail">'plural reference set path tail'</a>
		}
	)
}
</pre>
