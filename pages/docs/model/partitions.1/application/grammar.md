							...
							'<span class="token string">derived</span>' { [ <span class="token operator">=</span> ]
								...
								'<span class="token string">key constraint</span>': stategroup (
									'<span class="token string">partition</span>' {
										'<span class="token string">expression</span>': component <a href="#grammar-rule--partition-expression">'partition expression'</a>
									}
									'<span class="token string">no</span>' {
...
'<span class="token string">graph constraints definition</span>' {
	'<span class="token string">graphs</span>': dictionary {
		...
		// 	'<span class="token string">base</span>' { }
		// 	'<span class="token string">derived</span>' { [ <span class="token operator">=</span> <span class="token operator">order</span> ] }
		// )
	}
}
</pre>
...
{: #grammar-rule--partition-expression }
<div class="language-js highlighter-rouge">
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">partition expression</span>' { [ <span class="token operator">partition</span> ]
...
'<span class="token string">context object step</span>' {
	'<span class="token string">context</span>': stategroup (
		...
		'<span class="token string">dynamic user</span>' { [ <span class="token operator">user</span> ] }
		'<span class="token string">graph node</span>' {
			'<span class="token string">type</span>': stategroup (
			...
			'<span class="token string">graph</span>': [ <span class="token operator">in</span> ] reference
		}
	)
}
</pre>
...
The `@show-total:` annotation ensures that the sum is shown at the bottom of tables by default
