	...
	'<span class="token string">yes</span>' { @block indent
		...
		'<span class="token string">has external authentication</span>': stategroup (
			'<span class="token string">yes</span>' { @block indent
				...
				'<span class="token string">identity initializer</span>': indent [ <span class="token operator">identity-initializer</span> <span class="token operator">:</span> ] component <a href="#grammar-rule--identity-initializer">'identity initializer'</a>
			}
			'<span class="token string">no</span>' { }
		)
	}
...
'<span class="token string">ui command attribute</span>' { @list indent
	...
	'<span class="token string">handheld</span>': @block stategroup (
		'<span class="token string">true</span>' { [ <span class="token operator">@handheld:</span> ]
			'<span class="token string">has descriptor</span>': stategroup (
				'<span class="token string">yes</span>' {
					'<span class="token string">parts</span>': component <a href="#grammar-rule--ui-handheld-descriptor">'ui handheld descriptor'</a>
				}
				'<span class="token string">no</span>' { }
			)
		}
