...
```js
	...
	'text alignment' component unbound stategroup @default: 'middle' (
		'left' { }
		'middle' { }
		'right' { }
	)
	...
	'planning' component {
		...
		'windows': list non-empty {
			'label': text
			'rows': list non-empty feature 'planning rows'
	...
	'rows list' component list non-empty feature 'planning rows'
	'optional rows list' component stategroup @default: 'not set' @strategy (
		'set' feature 'rows list'
		'not set' none
	)
	'planning items' component binding nodes {
		...
		'text alignment': feature 'text alignment'
		'filters': feature 'optional filters'
		'node filters': feature 'optional node filters'
		'color': feature 'planning color'
		'tooltip': feature 'optional label'
