...
'<span class="token string">widget implementation node</span>' { [ <span class="token operator">{</span>, <span class="token operator">}</span> ]
	...
	'<span class="token string">optional attributes</span>': dictionary { @block indent
		'<span class="token string">attribute</span>': [ <span class="token operator">?</span> ] component <a href="#grammar-rule--widget-implementation-attribute">'widget implementation attribute'</a>
	}
}
</pre>
</div>
