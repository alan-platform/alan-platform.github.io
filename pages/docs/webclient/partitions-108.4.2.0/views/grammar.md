	...
	'<span class="token string">queries</span>': dictionary { [ <span class="token operator">query</span> ]
		...
		'<span class="token string">filters</span>': group {
			...
			'<span class="token string">filters</span>': dictionary { [ <span class="token operator">where</span> ]
						...
						'<span class="token string">type</span>': stategroup (
							...
							'<span class="token string">text</span>' { [ <span class="token operator">=</span> ]
								'<span class="token string">operator</span>': stategroup (
									...
									'<span class="token string">not in</span>' { [ <span class="token operator">not</span> ] }
								)
							...
							'<span class="token string">collection</span>' {
								...
								'<span class="token string">candidates</span>': [ <span class="token operator">query:</span> ] reference
							}
						)
					}
					'<span class="token string">node</span>' {
				...
				'<span class="token string">enabled</span>': stategroup (
					'<span class="token string">yes</span>' { }
	...
	'<span class="token string">type</span>': stategroup (
		...
		'<span class="token string">binding</span>' { [ <span class="token operator">::</span> ]
			'<span class="token string">type</span>': stategroup (
				...
				'<span class="token string">query filter</span>' { [ <span class="token operator">query</span> ]
					'<span class="token string">type</span>': stategroup (
						'<span class="token string">text</span>' { [ <span class="token operator">text</span> ] }
						'<span class="token string">generic</span>' { }
					)
					'<span class="token string">filter</span>': [ <span class="token operator">filter</span> ] reference
				}
				'<span class="token string">query collection filter</span>' {
					'<span class="token string">filter</span>': [ <span class="token operator">query</span> <span class="token operator">collection</span> <span class="token operator">filter</span> ] reference
				}
		...
		'<span class="token string">type</span>': [ <span class="token operator">:</span> ] stategroup (
			...
			'<span class="token string">collection</span>' {
				...
				'<span class="token string">has filter</span>': stategroup (
					'<span class="token string">no</span>' { }
					'<span class="token string">yes</span>' {
						'<span class="token string">candidates</span>': [ <span class="token operator">filter:</span> ] reference
					}
				)
				'<span class="token string">properties</span>': component <a href="#grammar-rule--node-query">'node query'</a>
			}
