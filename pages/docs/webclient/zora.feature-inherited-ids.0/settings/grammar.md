...
'<span class="token string">settings</span>': [ <span class="token operator">settings</span> ] group {
	...
	'<span class="token string">update permissions</span>': stategroup (
		'<span class="token string">no</span>' { [ <span class="token operator">no</span> <span class="token operator">permission</span> <span class="token operator">updates</span> ] }
