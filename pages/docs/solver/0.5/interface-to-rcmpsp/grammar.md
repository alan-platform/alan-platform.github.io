...
'<span class="token string">job mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
	...
	'<span class="token string">started</span>': [ <span class="token operator">started</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--stategroup-attribute">'stategroup attribute'</a>
	'<span class="token string">started options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
		'<span class="token string">yes</span>': [ <span class="token operator">|</span> <span class="token operator">started</span> <span class="token operator">=></span> ] reference
		'<span class="token string">no</span>': [ <span class="token operator">|</span> <span class="token operator">not-started</span> <span class="token operator">=></span> ] reference
	}
