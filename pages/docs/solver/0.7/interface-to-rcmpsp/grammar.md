...
'<span class="token string">resource mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
	...
	'<span class="token string">time slot mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
		'<span class="token string">worker pool groups</span>': [ <span class="token operator">worker-pool-groups</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--collection-attribute">'collection attribute'</a>
		'<span class="token string">worker pool group mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			'<span class="token string">group</span>': [ <span class="token operator">group</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--text-attribute">'text attribute'</a>
		}
		'<span class="token string">has capacity</span>': [ <span class="token operator">capacity</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--stategroup-attribute">'stategroup attribute'</a>
		'<span class="token string">has capacity options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			'<span class="token string">yes</span>': [ <span class="token operator">|</span> <span class="token operator">capacity</span> <span class="token operator">=></span> ] reference
			'<span class="token string">no</span>': [ <span class="token operator">|</span> <span class="token operator">no-capacity</span> <span class="token operator">=></span> ] reference
		}
	}
}
</pre>
...
'<span class="token string">job mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
	...
	'<span class="token string">task mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
		...
		'<span class="token string">external dependencies</span>': [ <span class="token operator">external-dependencies</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--collection-attribute">'collection attribute'</a>
		'<span class="token string">external dependency mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			'<span class="token string">tasks</span>': [ <span class="token operator">tasks</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--collection-attribute">'collection attribute'</a>
			'<span class="token string">task mapping</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
				...
				'<span class="token string">scheduling options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
					'<span class="token string">after</span>': [ <span class="token operator">|</span> <span class="token operator">after</span> <span class="token operator">=></span> ] reference
					'<span class="token string">parallel</span>': [ <span class="token operator">|</span> <span class="token operator">parallel</span> <span class="token operator">=></span> ] reference
				}
			}
		}
		...
		'<span class="token string">scheduling options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			...
			'<span class="token string">range</span>': [ <span class="token operator">|</span> <span class="token operator">range</span> <span class="token operator">=></span> ] reference
			'<span class="token string">range parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
				'<span class="token string">from</span>': [ <span class="token operator">from</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--stategroup-attribute">'stategroup attribute'</a>
				'<span class="token string">from options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
					'<span class="token string">yes</span>': [ <span class="token operator">|</span> <span class="token operator">from</span> <span class="token operator">=></span> ] reference
					'<span class="token string">yes parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
						'<span class="token string">time slot</span>': [ <span class="token operator">time-slot</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--reference-attribute">'reference attribute'</a>
					}
					'<span class="token string">no</span>': [ <span class="token operator">|</span> <span class="token operator">no-from</span> <span class="token operator">=></span> ] reference
				}
				'<span class="token string">to</span>': [ <span class="token operator">to</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--stategroup-attribute">'stategroup attribute'</a>
				'<span class="token string">to options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
					'<span class="token string">yes</span>': [ <span class="token operator">|</span> <span class="token operator">to</span> <span class="token operator">=></span> ] reference
					'<span class="token string">yes parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
						'<span class="token string">time slot</span>': [ <span class="token operator">time-slot</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--reference-attribute">'reference attribute'</a>
					}
					'<span class="token string">no</span>': [ <span class="token operator">|</span> <span class="token operator">no-to</span> <span class="token operator">=></span> ] reference
				}
			}
			...
			'<span class="token string">unlocked parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
				'<span class="token string">hint</span>': [ <span class="token operator">hint</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--stategroup-attribute">'stategroup attribute'</a>
				'<span class="token string">hint options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
					'<span class="token string">yes</span>': [ <span class="token operator">|</span> <span class="token operator">hint</span> <span class="token operator">=></span> ] reference
					'<span class="token string">yes parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
						'<span class="token string">start</span>': [ <span class="token operator">start</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--reference-attribute">'reference attribute'</a>
					}
					'<span class="token string">no</span>': [ <span class="token operator">|</span> <span class="token operator">no-hint</span> <span class="token operator">=></span> ] reference
				}
			}
		}
	}
...
'<span class="token string">command parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
	...
	'<span class="token string">status options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
		...
		'<span class="token string">unsolved parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			...
			'<span class="token string">unsolved cause options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
		...
		'<span class="token string">solved parameters</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
			...
			'<span class="token string">solution quality options</span>': [ <span class="token operator">(</span>, <span class="token operator">)</span> ] group {
...
{: #grammar-rule--text-attribute }
<div class="language-js highlighter-rouge">
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">text attribute</span>' {
	'<span class="token string">attribute</span>': reference
}
</pre>
</div>
