...
node-features
	...
	'planning rows' component binding collection {
		'label': feature 'label'
	...
	'planning items' component binding collection {
	...
	'planning background items' component binding collection {
		'label': feature 'optional label'
		'start and end': feature 'start and end'
		'options': feature 'item options'
	}
	...
	'<span class="token string">type</span>': stategroup (
		'<span class="token string">model binding</span>' {
			'<span class="token string">type</span>': stategroup (
				...
				'<span class="token string">nodes</span>' { [ <span class="token operator">on</span> ]
