...
'<span class="token string">custom queries</span>': dictionary { [ <span class="token operator">query</span> ]
	'<span class="token string">has more custom queries</span>': stategroup = node-switch successor (
		| node = '<span class="token string">yes</span>' { '<span class="token string">next custom query</span>' = successor }
	...
	'<span class="token string">has properties</span>': stategroup = node-switch .'<span class="token string">properties</span>' (
		| nodes = '<span class="token string">yes</span>' { '<span class="token string">first property</span>' = first }
		| none  = '<span class="token string">no</span>'
	)
...
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">has custom queries</span>': stategroup = node-switch .'<span class="token string">custom queries</span>' (
	| nodes = '<span class="token string">yes</span>' { '<span class="token string">first custom query</span>' = first }
	| none  = '<span class="token string">no</span>'
)
</pre>
</div>
