...
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">constraints</span>': dictionary { [ <span class="token operator">where</span> ]
	'<span class="token string">has prev</span>': stategroup = node-switch predecessor (
		| node = '<span class="token string">yes</span>' { '<span class="token string">prev</span>' = predecessor }
	...
	'<span class="token string">object</span>': [ <span class="token operator">-></span> ] component <a href="#grammar-rule--object-expression">'object expression'</a>
...
<div class="highlight">
<pre class="highlight language-js code-custom">
'<span class="token string">has constraint</span>': stategroup = node-switch .'<span class="token string">constraints</span>' (
...
'<span class="token string">object path</span>' {
	'<span class="token string">context</span>': stategroup (
		'<span class="token string">explicit</span>' {
			'<span class="token string">context</span>': stategroup (
				'<span class="token string">data constraint</span>' {
