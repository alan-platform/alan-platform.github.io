			...
			(
				'<span class="token string">explicit foreign key</span>'
					...
					(
						...
						'<span class="token string">plural context</span>'
							'<span class="token string">link</span>' [ <span class="token operator">>></span>, <span class="token operator">*</span> ] reference
					)
				'<span class="token string">implicit foreign key</span>'
					...
					(
						'<span class="token string">singular context</span>'
							...
							'<span class="token string">temp var</span>' component <a href="#grammar-rule--variable-assignment--context">'variable assignment: context'</a>
							'<span class="token string">expression</span>' component <a href="#grammar-rule--implicit-constraint">'implicit constraint'</a>
						'<span class="token string">plural context</span>'
							'<span class="token string">table</span>' [ <span class="token operator">>></span>, <span class="token operator">*</span> ] reference
							'<span class="token string">temp ctx</span>' component <a href="#grammar-rule--context-creation">'context creation'</a>
							'<span class="token string">temp var</span>' component <a href="#grammar-rule--variable-assignment--context">'variable assignment: context'</a>
							'<span class="token string">expression</span>' component <a href="#grammar-rule--implicit-constraint">'implicit constraint'</a>
					)
				'<span class="token string">child collection</span>' [ <span class="token operator">inverse</span> ]
					...
					(
						...
						'<span class="token string">plural context</span>'
							'<span class="token string">source</span>'      [ <span class="token operator">table</span> ] reference
							'<span class="token string">links to me</span>' [ <span class="token operator">></span>, <span class="token operator">*</span> ] reference
					)
			)
...
'<span class="token string">context selector</span>'
	...
	'<span class="token string">require</span>' stategroup ('<span class="token string">valid context</span>')
		...
		'<span class="token string">from context</span>'
			...
			(
				...
				'<span class="token string">none</span>'
					'<span class="token string">inequivalent set type</span>' component <a href="#grammar-rule--numerical-set-constraint">'numerical set constraint'</a>
			)
...
'<span class="token string">enum expression</span>'
	'<span class="token string">type</span>' stategroup (
		'<span class="token string">from context</span>'
			'<span class="token string">context is</span>' stategroup (
				'<span class="token string">singular context</span>'
				'<span class="token string">plural context</span>'
					'<span class="token string">operation</span>' stategroup (
						'<span class="token string">shared value</span>' [ <span class="token operator">shared</span> ]
			...
			'<span class="token string">selection</span>' component <a href="#grammar-rule--context-selector">'context selector'</a>
			'<span class="token string">field</span>' [ <span class="token operator">.</span> ] reference
			'<span class="token string">field is</span>' stategroup ('<span class="token string">enum</span>')
			'<span class="token string">null guard</span>' component <a href="#grammar-rule--null-guard">'null guard'</a>
		'<span class="token string">from variable</span>'
			'<span class="token string">selection</span>' component <a href="#grammar-rule--variable-selector">'variable selector'</a>
			'<span class="token string">is</span>' stategroup ('<span class="token string">enum</span>')
	)
</pre>
</div>
</div>
...
'<span class="token string">boolean expression</span>'
	...
	(
		...
		'<span class="token string">compare boolean</span>' [ <span class="token operator">bool</span> ]
			'<span class="token string">selection</span>' component <a href="#grammar-rule--context-selector">'context selector'</a>
			'<span class="token string">is</span>' stategroup
			(
				'<span class="token string">singular context</span>'
...
'<span class="token string">collection mapping</span>'[ <span class="token operator">=</span> ]
	...
	(
		...
		'<span class="token string">static entry</span>'
			'<span class="token string">key</span>' [ <span class="token operator">key</span> <span class="token operator">=</span> ] component <a href="#grammar-rule--text-expression">'text expression'</a>
...
'<span class="token string">state mapping</span>' [ <span class="token operator">=</span> ]
	...
	(
		...
		'<span class="token string">from context</span>'
			...
			'<span class="token string">field</span>' [ <span class="token operator">?</span> ] reference
			'<span class="token string">null guard</span>' component <a href="#grammar-rule--null-guard">'null guard'</a>
			'<span class="token string">field is</span>' [ <span class="token operator">)</span> ] stategroup ('<span class="token string">enum</span>')
