...
- **text**
	...
	You can define [validation rules](/pages/docs/model/97/application/grammar.html#user-interface-annotations) on text values for the user interface, e.g. minimum length or a specific pattern.
...
You can [annotate your model](/pages/docs/model/97/application/grammar.html#user-interface-annotations) to set default values and [number formats](/pages/docs/model/97/application/grammar.html#numerical-types). Check the [model language docs](/pages/docs/model/97/application/grammar.html) for more details.
